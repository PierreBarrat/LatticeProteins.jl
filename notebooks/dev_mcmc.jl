...
@load "../data/structures_N3_filtering0.1.jld2" structures
...
parameters = MCMCParameters(;
	n_steps=10, n_sequences=1000, structures, target, burnin=0, β_sampling=100.
)

# ╔═╡ 19584b24-6af7-4e35-8c4d-360acf8b592c
...
map(x -> LP.fold_prob(x, structures, target), chain) |> plot

# ╔═╡ dced7c85-2002-4387-9a6c-80c0784aeab5
chain
